import { TDT_TK, MAP_TYPES } from './config.js'
...
// 获取指定地图类型的图层URL
export const getMapTypeUrls = (mapType) => {
...
// 格式坐标显示
export const formatCoordinate = (value, decimalPlaces = 6) => {
    return value.toFixed(decimalPlaces)
}

// 判断位置信息
export const getLocationInfo = (center) => {
